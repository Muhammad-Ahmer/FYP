...
function FormatsTabs() {
    ...
    return (
        <View
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Pressable onPress={() => setFormat('hex')}>
                    <Text
                        style={[
                            styles.tabText,
                            { borderColor: Format === 'hex' ? '#666666' : '#fff' },
                        ]}>
                        HEX
                    </Text>
                </Pressable>
                <Pressable onPress={() => setFormat('rgba')}>
                    <Text
                        style={[
                            styles.tabText,
                            { borderColor: Format === 'rgba' ? '#666666' : '#fff' },
                        ]}>
                        RGBA
                    </Text>
                </Pressable>
                <Pressable onPress={() => setFormat('hsla')}>
                    <Text
                        style={[
                            styles.tabText,
                            { borderColor: Format === 'hsla' ? '#666666' : '#fff' },
                        ]}>
                        HSLA
                    </Text>
                </Pressable>
            ...
            <PreviewText
                style={{ marginVertical: 20, fontSize: 18, color: '#293241' }}
                colorFormat={Format}
            />
        </View>
    );
                ...
                <View style={styles.container}>
                    <ColorPicker
                        ...
                        <View style={styles.panelBrightnessContainer}>
                            ...
                            <Preview
                                style={[styles.circlePreview, styles.shadow]}
                                hideInitialColor
                                hideText
                            />
                        </View>
